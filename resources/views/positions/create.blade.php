        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded shadow-md max-w-md w-full mx-auto">
            ...
            <form action="{{ route('positions.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="amount" value="{{ old('amount') }}" class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 
